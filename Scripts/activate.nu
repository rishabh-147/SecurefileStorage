...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\tiwar\PycharmProjects\SecurefileStorage\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\tiwar\PycharmProjects\SecurefileStorage\venv\Scripts\deactivate.nu'
